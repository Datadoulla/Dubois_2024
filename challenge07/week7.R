...
data |> 
  ...
  labs(title = 'Illiteracy of the American Negroes compared with that of other nations.',
       ...
       #caption = '<i class="fa-brands fa-github"></i>'
       )+
  theme(
    axis.title = element_blank(),
    axis.text.x = element_blank(),
    axis.ticks = element_blank(),
    axis.text.y = element_text(hjust = 0, face = 'bold', size = 9),
    ...
    plot.title = element_text(hjust = .5, vjust = -9, face = 'bold', size = 12,
    ),
    plot.subtitle = element_text(hjust = .5, vjust = -20, size = 9),
...
# Saving  ---------------------------------------------------
#ggsave('challenge07/plate_w7.png', p ,width = 6.8, height = 8, limitsize = F)
